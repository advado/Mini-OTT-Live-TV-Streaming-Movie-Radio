...
import static com.dbug.livetv.config.Constant.ADMIN_PANEL_PATH;
import static com.dbug.livetv.config.Constant.ADS_URL;
import static com.dbug.livetv.config.Constant.CATEGORY_ALL_ITEM_URL;
import static com.dbug.livetv.config.Constant.CATEGORY_PANEL_URL;
import static com.dbug.livetv.config.Constant.POST_FCM_TOKEN;
import static com.dbug.livetv.config.Constant.POST_PANEL_URL;
import static com.dbug.livetv.config.Constant.POST_SLIDER_VIDEO_COUNT;
import static com.dbug.livetv.config.Constant.POST_VIDEO_COUNT;
import static com.dbug.livetv.config.Constant.SLIDERS_PANEL_URL;
